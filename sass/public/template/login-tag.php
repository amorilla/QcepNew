            ...
            <div>
                <div>
                    ...
                    if (isset($_SESSION['user_info'])) {
                        echo '<h1>¡Ya estás en Login! Si quieres cerrar sesión, haz clic <a href="?user/loginOut">aquí</a></h1>';
                        echo '<form action="?user/loginOut" method="post">',
                        '<button type="submit" name="boto" class="btn btn-primary">Cerrar Sesión</button>' .
                            '</form>';
                    } else {
